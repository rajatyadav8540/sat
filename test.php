            ...
            <ul class="navbar-nav ml-auto mt-0">
                  ...
                  <?php
                    ...
                    $nqrfe=mysqli_fetch_array($nqr);
                        ...
                        ?>
                         <li class="nav-item mx-2 active"><a href="memberpage.php" class="nav-link"><img src="<?php echo $nqrfe['image']; ?>" alt="" class="img-fluid rounded-circle" width="50" height="40"></a></li>
                     <?php }else{ ?>
